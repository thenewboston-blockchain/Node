...
class BlockManager(models.DjongoManager):
    # TODO(dmu) LOW: Consider using BlockchainFacade instead of BlockManager
    ...
    def add_block_from_signed_change_request(
        ...
        *,
        ...
        block_message = BlockMessage.create_from_signed_change_request(signed_change_request)
