...
@pytest.fixture
def confirmation_validator_node(confirmation_validator_key_pair):
    return make_node(
        confirmation_validator_key_pair, ['http://not-existing-confirmation-validator-address-674898923.com:8555/']
    )
